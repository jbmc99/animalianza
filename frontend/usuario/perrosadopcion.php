...
<div class="container text-center mb-5">
    ...
    <div class="d-flex flex-wrap justify-content-center ms-5 me-2">
        ...
        if (isset($_SESSION['id_protectora'])) {
            ...
            // Consultar la base de datos para obtener todas las tarjetas de perros de la protectora actual
            $sql = "SELECT * FROM animal WHERE especie = 'perro' AND id_protectora = $id_protectora";
            $resultado = $conn->query($sql);

            // Verificar si se encontraron perros
            if ($resultado->num_rows > 0) {
                // Mostrar todas las tarjetas de perros de la protectora actual
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo '<a href="fichaperro1.php?id=' . $fila['id_animal'] . '" class="btn btn-link text-dark text-decoration-none">';
