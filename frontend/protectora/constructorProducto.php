        ...
        <div class="col-md-8">
            ...
            <form action="procesar_producto.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" id="descripcionProducto" name="descripcionProducto" rows="4" placeholder="Introduzca una descripción del producto"></textarea>
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label for="precioProducto" class="col-sm-4 col-form-label">Precio del Producto</label>
                    <div class="col-sm-8">
                        <input type="number" class="form-control" id="precioProducto" name="precioProducto" placeholder="Introduzca el precio del producto">
                    </div>
                </div>
