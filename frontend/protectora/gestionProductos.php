...
<div class="container mt-5">
            ...
            <div class="card border-0 rounded-3 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="../usuario/infoproducto.php" class="btn btn-success me-2">Más información</a>
        ...
        <div class="col-lg-3 mb-4 me-5">
            <div class="card border-0 rounded-3 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">$XX.XX</h6>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-success me-2">Más información</a>
                        <a href="#" class="btn btn-success">Editar producto</a>
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-auto text-center">
            <a href="#" class="btn btn-success mx-auto">Añadir producto</a>
        </div>
        <div class="col-lg-auto text-center">
            <a href="#" class="btn btn-success mx-auto">Eliminar producto</a>
        </div>
    </div>
</div>
